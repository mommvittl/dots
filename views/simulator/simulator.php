...
function getNewCommand(){
    var theParam = 'data=' + JSON.stringify( { 'lastDotId' : lastDotId, 'lastPoligonId' : lastPoligonId, 'lastDelDotId' : lastDelDotId, 'lastDelPoligonId' : lastDelPoligonId } );
    ajaxGet.setAjaxQuery('http://project/round/get_change' , theParam , getResponseScript , 'POST' , 'text');
}
...
function changePosition(){	
	...
	ajaxPost.setAjaxQuery('http://project/round/change_position' , theParam , viewNewPosition , 'POST' , 'text');
	//--------------------------
