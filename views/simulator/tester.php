...
<BUTTON type="button" id="gameControl" style=" position: fixed; right: 10px; bottom: 10px; z-index: 1000; padding: 5px;width: 20vw; height: 10vh; cursor: pointer; background: #FF7F50; font-size: 20px; ">START/STOP</BUTTON>
