...
<div id="informStr" style="position: fixed; left: 10px; bottom: 5px; z-index: 1000; padding: 5px; width: 70vw; background: black; color: white; font: 20px/23px arial; text-align: center;">Кликните старт</div>
