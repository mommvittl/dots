    ...
    public function actionSimulator4() {
        ...
        <HTML>
            ...
            <BODY>
                ...
                <p id="informStr" style="background: black; color: white; font: 1.2rem/1.4rem arial; text-align: center;"><?php echo $strStartMess ?></p>
                <div id="YMapsID" style="width: 900px; height: 700px; margin: 0 auto; "></div>
                ...
                <script>
                    ...
                    function  responseStatusGameOver(response) {
                        ...
                        var mess = "Окончание игры. Победитель " + statusGame.winner + " Ваши очки: " +  statusGame.scoresMe + " очки соперника: " + statusGame.scoresEnemy ;
                        alert( mess );
                        removeGame();
                    }
